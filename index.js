...
export function registerClawAegisPlugin(api, createRuntime = createClawAegisRuntime) {
    try {
        ...
        api.on("message_received", wrapHookFailOpen(api, "message_received", runtime.hooks.message_received));
        ...
        api.on("after_tool_call", wrapHookFailOpen(api, "after_tool_call", runtime.hooks.after_tool_call));
        api.on("before_message_write", wrapHookFailOpen(api, "before_message_write", runtime.hooks.before_message_write));
